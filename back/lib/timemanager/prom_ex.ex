defmodule Timemanager.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule TimemanagerWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Timemanager.PromEx
  ...
  use PromEx, otp_app: :timemanager
  ...
  def plugins do
    [
      ...
      # Timemanager.Users.PromExPlugin
  ...
  def dashboard_assigns do
    [
      datasource_id: "d1e42fd6-24e1-47d7-a986-5ee3f56b1e3c",
  ...
  def dashboards do
    [
      ...
      # {:timemanager, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
