...
const isManager = ref(sessionStorage.getItem('role') !== 'User')
    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          ...
          <span class="mx-2 text-2xl font-semibold text-white">Time Manager</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[route.name === 'Timemanagement' ? activeClass : inactiveClass]"
          to="/timemanagement"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Time Management</span>
        </router-link>

        <router-link
          v-if="isManager && !onPhone"
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
